...
@section('content')
    <div class="row mx-1">
        ...
        <div class="card">
            <h3 class="card-head my-2 mx-2 mt-3">Edit Review</h3>
            <div class="card-body mx-2">
                <form action="{{ route('review.update', $review) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" placeholder="John Doe" value="{{ old('name', $review->name) }}" />
                            @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('position') is-invalid @enderror"
                                name="position" id="position" placeholder="CEO" value="{{ old('position', $review->position) }}" />
                            @error('position')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="message" id="message" class="form-control @error('message') is-invalid @enderror"
                                placeholder="Review message" aria-label="Message">{{ old('message', $review->message) }}</textarea>
                            @error('message')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img src="{{ $review->image ? asset('storage/' . $review->image) : asset('assets/img/placeholder.png') }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ old('status', $review->status) ? 'checked' : '' }}>
